...
exports.kycSessionService = exports.KycSessionService = void 0;
const uuid_1 = require("uuid");
const credentialService_js_1 = require("./credentialService.js");
// In-memory session store (use Redis in production)
const sessions = new Map();
// Session expiration time (30 minutes)
const SESSION_TTL = 30 * 60 * 1000;
class KycSessionService {
    createSession(walletAddress, credentialType) {
    ...
    async processVerification(sessionId) {
        const session = this.getSession(sessionId);
        if (!session) {
        ...
        try {
            ...
            if (verificationResult.passed) {
                ...
                const credentialResult = await credentialService_js_1.credentialService.issueCredential({
    ...
    async verifyKycData(session) {
        ...
        switch (credentialType) {
            ...
            case 'accreditedInvestor':
                ...
                if (data.country === 'US') {
                    if ((!data.annualIncome || data.annualIncome < 200000) &&
                        (!data.netWorth || data.netWorth < 1000000)) {
                        return {
                            passed: false,
                            reason: 'Must have annual income > $200,000 or net worth > $1,000,000 (excluding primary residence)',
                        };
                    }
                }
                break;
...
exports.KycSessionService = KycSessionService;
exports.kycSessionService = new KycSessionService();
//# sourceMappingURL=kycSessionService.js.map